...
export const LIST_FOUNDATION = [
  ...
  },
  {
    ...
    description: 'Chỉ cần có thiết bị kết nối internet, học viên có thể truy cập kho bài giảng phong phú của Physics Outreach mọi lúc, mọi nơi, đảm bảo quá trình học tập không bị gián đoạn.',
  ...
  },
  {
    ...
    description: 'Physics Outreach quy tụ những giảng viên xuất sắc, có nhiều năm kinh nghiệm trong giảng dạy và nghiên cứu, cam kết mang đến những bài giảng chất lượng cao, dễ hiểu và truyền cảm hứng.',

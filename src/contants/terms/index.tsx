...
export const TERMS_LIST = [
  {
    ...
    content: (
      <>
        Chào mừng bạn đến với Physics Outreach! Bằng cách truy cập và sử dụng trang web <a href="www.amerian.study" className="underline text-primary-main cursor-pointer">www.amerian.study</a> (sau đây gọi là &#34;Website&#34;), bạn đồng ý với các điều khoản và điều kiện dưới đây.
      </>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <br/>
        &#8226;&nbsp;Physics Outreach có quyền tạm ngưng hoặc hủy tài khoản nếu phát hiện hành vi vi phạm.
      </>
    )
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        &#8226;&nbsp;Mọi nội dung khóa học thuộc quyền sở hữu của Physics Outreach.
        <br/>
  ...
  },
  {
    ...
    content: (
      <>
        Physics Outreach không chịu trách nhiệm về các lỗi phát sinh do đường truyền, phần cứng, phần mềm ngoài phạm vi kiểm soát.
      </>
    )
  },
  {

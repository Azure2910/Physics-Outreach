      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-[40%] xl:w-[35%] px-4 sm:px-6 md:px-8 lg:px-6 xl:px-8 py-8 lg:py-0 min-h-screen">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <button
            ...
            className="mt-6 sm:mt-8 text-sm sm:text-base text-[#637381] hover:text-[#FF7F36] cursor-pointer flex items-center justify-center gap-2 w-full transition-colors"
            disabled={isPending}
          >
            <span>←</span>
            Quay lại đăng nhập

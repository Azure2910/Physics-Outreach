        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex justify-center gap-2 text-sm sm:text-base text-[#212B36]">
              ...
              <span
                className="text-[#FF7F36] cursor-pointer hover:underline font-medium"
            ...
            >
                  ...
                  <FormItem>
                    <FormControl>
                      <Input
                        type="email"
                        placeholder="Email"
                        className="w-full border border-gray-200 rounded-[10px] px-4 py-2 h-11 sm:h-12 focus:border-[#FF7F36] focus:ring-[#FF7F36] text-sm sm:text-base"
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          className="w-full border border-gray-200 rounded-[10px] px-4 py-2 h-11 sm:h-12 pr-12 focus:border-[#FF7F36] focus:ring-[#FF7F36] text-sm sm:text-base"
                          disabled={isPending || isPendingGoogle}
                          {...field}
                        />
                        <button
              ...
              <div className="flex justify-end">
                <div
                  ...
                  className="underline text-xs sm:text-sm cursor-pointer hover:text-[#FF7F36] transition-colors"
                >
                  Quên mật khẩu?
                </div>
              </div>
